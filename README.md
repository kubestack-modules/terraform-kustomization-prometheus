...
This module installs Prometheus on Kubernetes.
...
The module bundles an upstream release of Prometheus and makes it fully configurable with Kustomizations set as input attributes.
...
module "example_$module_name" {
  ...
  source  = "kubestack-modules/prometheus/kustomization"
